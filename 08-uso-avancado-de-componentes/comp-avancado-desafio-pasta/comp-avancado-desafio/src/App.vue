<template>
	<div id="app">
		<span>
			<button @click="componente = 'Vermelho'"
				class="vermelho">Carregar Componente Vermelho</button>
			<button @click="componente = 'Verde'"
				class="verde">Carregar Componente Verde</button>
			<button @click="componente = 'Azul'"
				class="azul">Carregar Componente Azul</button>
		</span>

		<component :is='componente'>
				<span :slot="componente">Carregar Componente <strong>{{ componente }}</strong></span>
		</component>
