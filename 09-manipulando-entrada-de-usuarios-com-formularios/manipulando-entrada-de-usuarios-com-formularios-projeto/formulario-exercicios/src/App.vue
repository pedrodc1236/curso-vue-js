		...
		<div class="conteudo">
			<form class="painel" v-if="!toSend">
				...
				<Rotulo nome="Mensagem">
					<textarea name="" cols="30" rows="5" v-model="mensage"></textarea>
				</Rotulo>
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="prioridade in prioridades" 
								:value="prioridade.code"
								:key="prioridade.code">
								{{ prioridade.name }}</option>
					</select>
				</Rotulo>
				<Rotulo nome="Primeira Reclamação?">
					<Escolha v-model="selectInput"/>
				</Rotulo>
				<hr>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<span>
						<ul>
							<li v-for="c in caracteres" :key="c">{{ c }}</li>
						</ul>
					</span>
				</Rotulo>
				<Rotulo nome="Qual produto?">
